 ...
 */
!function(a){"use strict";a(function(){var b=a(window),c=a(document.body);c.scrollspy({target:".bs-docs-sidebar"}),b.on("load",function(){c.scrollspy("refresh")}),a(".bs-docs-container [href=#]").click(function(a){a.preventDefault()}),setTimeout(function(){var b=a(".bs-docs-sidebar");b.affix({offset:{top:function(){var c=b.offset().top,d=parseInt(b.children(0).css("margin-top"),10),e=a(".bs-docs-nav").height();return this.top=c-e-d},bottom:function(){return this.bottom=a(".bs-docs-footer").outerHeight(!0)}}})},100),setTimeout(function(){a(".bs-top").affix()},100),function(){var b=a("#bs-theme-stylesheet"),c=a(".bs-docs-theme-toggle"),d=function(){b.attr("href",b.attr("data-href")),c.text("Disable theme preview"),localStorage.setItem("previewTheme",!0)};localStorage.getItem("previewTheme")&&d(),c.click(function(){var a=b.attr("href");a&&0!==a.indexOf("data")?(b.attr("href",""),c.text("Preview theme"),localStorage.removeItem("previewTheme")):d()})}(),a(document).on("click",".toggle-design-btn",function(b){var c=a(b.target);c.parent().next().toggleClass("open")}),a("#loading-example-btn").on("click",function(){var b=a(this);b.button("loading"),setTimeout(function(){b.button("reset")},3e3)}),a("#exampleModal").on("show",function(b){var c=a(b.relatedTarget),d=c.data("whatever"),e=a(this);e.find(".modal-title").text("New message to "+d),e.find(".modal-body input").val(d)}),a(".bs-docs-activate-animated-progressbar").on("click",function(){a(this).siblings(".progress").find(".progress-bar-striped").toggleClass("active")}),a("#datepicker-input-js").datepicker(),a("#datepicker-inline-1").datepicker(),a("#ac-js-input").autocomplete({serviceUrl:"../json/ac-strings.json"}),a(".btn-intro").click(function(){a.introJs().start()}),ZeroClipboard.config({moviePath:"/assets/flash/ZeroClipboard.swf",hoverClass:"btn-clipboard-hover"}),a(".highlight").each(function(){var b='<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div>';a(this).before(b)});var d=new ZeroClipboard(a(".btn-clipboard")),e=a("#global-zeroclipboard-html-bridge");d.on("load",function(){e.data("placement","top").attr("title","Copy to clipboard").tooltip()}),d.on("dataRequested",function(b){var c=a(this).parent().nextAll(".highlight").first();b.setText(c.text())}),d.on("complete",function(){e.attr("title","Copied!").tooltip("fixTitle").tooltip("show").attr("title","Copy to clipboard").tooltip("fixTitle")}),d.on("noflash wrongflash",function(){e.attr("title","Flash required").tooltip("fixTitle").tooltip("show")}),a("#toast-topleft").click(function(b){b.preventDefault(),a.toast({text:"button topleft danger",type:"danger",position:"top left"})}),a("#toast-top").click(function(b){b.preventDefault(),a.toast({text:"button top success",posititon:"top",type:"success"})}),a("#toast-topright").click(function(b){b.preventDefault(),a.toast({text:"button topright warning",type:"warning",position:"top right"})}),a("#toast-center").click(function(b){b.preventDefault(),a.toast({text:"button center danger",type:"danger",position:"center"})}),a("#toast-bottomleft").click(function(b){b.preventDefault(),a.toast({text:"button bottomleft danger",type:"danger",position:"bottom left"})}),a("#toast-bottom").click(function(b){b.preventDefault(),a.toast({text:"button bottom success",type:"success",position:"bottom"})}),a("#toast-bottomright").click(function(b){b.preventDefault(),a.toast("button bottomright warning","warning","bottom right")})});var b=["../dist/css/sui-pink.css","../dist/css/sui-theme-pink.css","../dist/css/sui-green.css","../dist/css/sui-theme-green.css","../dist/css/sui-dark-green","../dist/css/sui-theme-dark-green.css"];b.forEach(function(b){var c=a("<link>");c.href=b,console.log(c)}),a("#colorGroup li").click(function(){var b=a("#changeColor").data("old"),c=a(this).children("a").attr("value");localStorage.setItem("currentSkin",c),a("#changeColor").data("old",c);var d="#28a3ef";"green"===c?d="#4a8e57":"pink"===c?d="#b654a7":"dark-green"===c&&(d="#518594"),a("#changeColor").css("color",d),c!==b&&("default"!==c?(a("#skin").attr("href","../dist/css/sui-"+c+".css"),a("#bs-theme-stylesheet").attr("href","../dist/css/sui-theme-"+c+".css")):(a("#skin").attr("href","../dist/css/sui.css"),a("#bs-theme-stylesheet").attr("href","../dist/css/sui-theme.css")))});var c=localStorage.getItem("currentSkin"),d="#28a3ef";"green"===c?d="#4a8e57":"pink"===c?d="#b654a7":"dark-green"===c&&(d="#518594"),a("#changeColor").css("color",d)}(jQuery);